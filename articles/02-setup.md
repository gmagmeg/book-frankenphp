...
この章では、FrankenPHPの開発環境を構築していきます。今回の書籍で使う環境情報はこちらに用意しているので、`git clone` して進めてください。https://github.com/gmagmeg/book-frankenphp-docker
...
構成は次のとおりです。- アプリケーションサーバー: FrankenPHP（Laravel Octane worker モード）- フレームワーク: Laravel 12 - データベース: PostgreSQL - 公開ポート: `8100`
